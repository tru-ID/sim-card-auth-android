...
- Clone or unzip the repo into a directory.
...
```
- Connect your phone to your computer so it's used for running the application
...
- You will see the result of the check
